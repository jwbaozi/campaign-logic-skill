...
5. Use `workflows/knowledge-routing.md` and `knowledge/source-routing.md` only for the smallest relevant knowledge set. Explain why a selected methodology changes the decision and how its conclusion enters the next step. Do not apply a model merely to sound professional.
